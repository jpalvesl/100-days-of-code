...
**Progresso do dia:** Estudei um pouco sobre cores, tentei mudar as cores do site, arrumei alguns erros no texto, porém ainda não estou achando ela tão agradável, vou dedicar o dia de amanhã prra estudar sobre cores e hierarquia.
